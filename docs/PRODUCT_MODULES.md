...
| Уведомления (§3) | отложено явно | Фазы 1–2 — pull-модель (read API); после MVP — тонкий потребитель на шине событий. Зафиксировано как решение. |
...
14. **Уведомления**: подтвердить у PO отсрочку до пост-MVP тонкого потребителя событий (зафиксировано как решение).
