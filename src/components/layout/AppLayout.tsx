...
const PAGE_TITLES: Array<[string, string, string]> = [
  ...
  ['/intake/chat', 'ИИ-ассистент заявки', 'Опишите потребность в диалоге — ассистент соберёт заявку по шаблону.'],
  ['/intake', 'Новая заявка', 'Выберите шаблон и заполните обязательное ядро.'],
